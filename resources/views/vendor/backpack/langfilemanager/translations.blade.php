...
<!-- Default box -->
  <div class="box">
    ...
    <div class="box-body">
		...
		@if (!empty($fileArray))
			{!! Form::open(array('url' => \Illuminate\Support\Facades\Request::url(), 'method' => 'post', 'id' => 'lang-form', 'class' => 'form-horizontal', 'data-required' => trans('admin.language.fields_required'))) !!}
