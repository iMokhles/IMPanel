...
@section('header')
	<section class="content-header">
	  <h1>
	    <span class="text-capitalize">NavBarBtns Manager</span>
    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header {{ $crud->hasAccess('create')?'with-border':'' }}">
            <h3 class="box-title">NavBarBtns Manager</h3>
        </div>

        <div class="box-body">
            <div class="col-sm-4">
                @include('admin.pages.navbar_btns_manager.inc.active_btns', ['sectionId' => "1_active"])
                @include('admin.pages.navbar_btns_manager.inc.disabled_btns', ['sectionId' => "1_inactive"])
            </div>
